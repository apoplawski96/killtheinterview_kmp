...
val LightColorPalette = KTIColors(
    ...
    backgroundSurface = kti_pinterest_white,
    backgroundSurfaceVariant = kti_pinterest_light_grey,
...
val DarkColorPalette = KTIColors(
    ...
    textMain = white,
    textVariant = white80,
    textVariant2 = white70,
    textVariant3 = white50,
    textVariant4 = kti_offblack,
    textVariant5 = kti_dark_grey,
    textVariant6 = kti_mid_grey,
    backgroundRoot = kti_offblack,
    backgroundSurface = kti_pinterest_dark,
    backgroundSurfaceVariant = kti_pinterest_grey,
    backgroundSurfaceVariant2 = kti_pinterest_grey,
